...
namespace Datadog.iOS.DatadogRUM
{
	...
	// NOTE: DDRUM and DDRUMConfiguration have been removed.
	// DDRUMConfiguration is a Swift class stub (__objc_stublist) that dyld cannot
	// resolve at launch. All RUM initialization goes through DDWrapperRUM instead.
}
